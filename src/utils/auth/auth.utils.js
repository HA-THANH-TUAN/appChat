...
const createTokenPair = (payload, privateKey) => {
  const accessToken = jwt.sign(payload, privateKey, {
    expiresIn: TIME_EXPIRED_ACCESSTOKEN,
    algorithm: ALIGORITHM_ACCESSTOKEN,
  });
  const refreshToken = jwt.sign(payload, privateKey, {
    expiresIn: TIME_EXPIRED_REFRESHTOKEN,
    algorithm: ALIGORITHM_REFRESHTOKEN,
  });
...
module.exports = {
  ...
  TIME_EXPIRED_ACCESSTOKEN,
  TIME_EXPIRED_REFRESHTOKEN,
  ALIGORITHM_ACCESSTOKEN,
  ALIGORITHM_REFRESHTOKEN,
};
